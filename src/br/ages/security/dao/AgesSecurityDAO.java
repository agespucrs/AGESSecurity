...
public class AgesSecurityDAO implements IAgesSecurityDAO {
	...
	public AgesSecurityUser verifyUserByUsername(String username) throws ClassNotFoundException, SQLException {
		AgesSecurityUser user = null;
	...
	public boolean Create(String username, String password)
		...
		AgesSecurityUser user = verifyUserByUsername(username);
		if (user == null) {
			user = new AgesSecurityUser();
